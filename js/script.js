...
productContainer.addEventListener('click', function(e){
    if(e.target.className == 'btn-buy'){
        window.open("https://api.whatsapp.com/send/?phone=6282347533504&text="+pesanPembuka+" *"+namaProduct.textContent+"* (" + hargaProduct.textContent + ") sebanyak *" +numSpinner.value + "*. " + pesanPenutup);
    };
});
